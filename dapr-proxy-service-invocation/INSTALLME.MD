12/31/22 Under construction.

# dapr-proxy-service-invocation Installation Instructions
Completed Saturday 12/31/22.

## Prerequisites
You need to fulfill 2 prerequisites to use this code sample.
...
2. Docker Desktop needs to be **installed on *each machine*** to support the Dapr container and others as well.
...
**Docker Desktop** --  Get the free version of Docker, including Docker Desktop.  Just follow the instructions at https://docs.docker.com/get-docker/
...
* The code sample Requires that Docker be installed.  Therefore DO NOT use the command **dapr init --slim**, rather than the standard **dapr init** command.  
