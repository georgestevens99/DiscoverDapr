...
1. Microsoft Visual Studio IDE (integrated development environment) needs to be **installed on *your dev machine*** that will run one of the services in the code sample.  The Microsoft **Visual Studio Community** edition is free.

2. Docker Desktop needs to be **installed on *your dev machine*** to support the Dapr container and others as well.

3. **Dapr** needs to be **installed on *your dev machine*** that will run one of the services in the code sample. The code sample will work with any version of Dapr that is compatible with v1.9.2 Dapr runtime and v1.9.0 Dapr CLI.  Dapr is free of charge.
...
2.**Update the LocalRepoPath path names in the StartRunServicesAndUI.txt file** in Visual Studio.  Commands in this file are used when you actually run services in the VS solution via Command Prompt windows.
  ...
  * Replace the string "LocalRepoPath"" with the actual full path string you saved above.  Do this in the 2 lines in StartRunServicesAndUI.txt shown below:
