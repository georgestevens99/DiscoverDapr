...
Note the above Implementation Diagram implements exactly the same system as shown in the previous *Logical Diagram* of the software.  It just implements the software in a different way -- on 2 machines in 2 Dapr-Meshes.
